...
public class Masin2_1 {
    ...
    public static int solution(String str1, String str2) {
        ...
        for(int i=1; i<str1.length(); i++) { // str1 부분집합
        ...
        for(int i=1; i<str2.length(); i++) { // str2 부분집합
        ...
        if (map1.size() == 0 && map2.size() == 0) return 65536; // A와 B 모두 공집합일 경우
        ...
        for(String s : map1.keySet()) { // 공집합 연산
        ...
        for(String s : map2.keySet()) { // 합집합 연산
            hap += map2.get(s);
        }
